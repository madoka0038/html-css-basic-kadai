...
<footer class="footer">
  ...
  <!--jQuery-->
  <script src="<?php echo get_template_derectory_uri(); ?>/js/jqueru-3.2.1.min.js"></script>
  <script src="<?php echo get_template_derectory_uri(); ?>/styles/bootstrap4/popper.js">/</script>
  <script src="<?php echo get_template_derectory_uri(); ?>/styles/bootstrap4/bootstrap.min.js"></script>
