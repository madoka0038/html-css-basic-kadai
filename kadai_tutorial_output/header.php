...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo get_template_derectory_uri(); ?>/styles/bootstrap4/bootstrap.min.css"/>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo get_template_derectory_uri(); ?>/styles/main_styles.css"/>
 <?php wp_head(); ?>
</head>
          ...
          <nav class="navbar navbar-expand-lg">
            <div class="logo_container">
              <a href="index.php">
                <div class="logo_text">
                  <a href="/">
                    <img src="<?php echo get_template_derectory_uri(); ?>/images/logo_big.png" />
