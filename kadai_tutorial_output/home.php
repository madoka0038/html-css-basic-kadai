          ...
          <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="<?php echo get_template_directory_uri(); ?>/imeges/top1_1200_630.jpg" class="d-block w-100" style="background-color: #2b7b8e26"/>
              ...
              <img src="<?php echo get_template_directory_uri(); ?>/imeges/top2_1200_630.jpg" class="d-block w-100"/>
                <div class="carousel-caption d-none d-md-block">
                  <img src="<?php echo get_template_derectory_uri(); ?>/imeges/logo_big_slide.png"/>
                  <div class="title-slide">
                    <p>Samurai University</p>
                  </div>
                  <div class="content-slide">
      ...
      <div class="footer_row">
        ...
        <div class="row courses_row">
          ...
          <div class="col-lg-4 course_col">
            <div class="course">
              <div class="course_image">
              </div><img src="<?php echo get_template_directory_uri(); ?>/images/pic6-1.jpg" alt="" />
              <div class="course_body">
                <h3 class="course_title">
